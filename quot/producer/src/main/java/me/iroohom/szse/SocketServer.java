...
public class SocketServer {
    ...
    private static List<String> parseStockFile() {
        ...
        try {
            //本地磁盘路径
            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("D:\\itcast\\Flink\\Project\\今日指数\\第1章\\4.资料\\需求文档\\数据源接口文档\\数据源文件\\szse-stock.txt")),"UTF-8"));
            //服务器磁盘路径
    ...
    public static List<String> parseIndexFile() {
        ...
        try {
            //本地磁盘路径
            BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(new File("D:\\itcast\\Flink\\Project\\今日指数\\第1章\\4.资料\\需求文档\\数据源接口文档\\数据源文件\\szse-index.txt")),"UTF-8"));
            //服务器磁盘路径
