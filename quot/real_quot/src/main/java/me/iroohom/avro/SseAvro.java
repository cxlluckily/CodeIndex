...
public class SseAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public CharSequence market;
   ...
   */
  public SseAvro(CharSequence market, CharSequence mdStreamID, CharSequence securityID, CharSequence symbol, Long tradeVolume, Long totalValueTraded, Double preClosePx, Double openPrice, Double highPrice, Double lowPrice, Double tradePrice, Double closePx, CharSequence tradingPhaseCode, Long timestamp) {
    this.market = market;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: market = (CharSequence)value$; break;
    case 1: mdStreamID = (CharSequence)value$; break;
    case 2: securityID = (CharSequence)value$; break;
    case 3: symbol = (CharSequence)value$; break;
    case 4: tradeVolume = (Long)value$; break;
    case 5: totalValueTraded = (Long)value$; break;
    case 6: preClosePx = (Double)value$; break;
    case 7: openPrice = (Double)value$; break;
    case 8: highPrice = (Double)value$; break;
    case 9: lowPrice = (Double)value$; break;
    case 10: tradePrice = (Double)value$; break;
    case 11: closePx = (Double)value$; break;
    case 12: tradingPhaseCode = (CharSequence)value$; break;
    case 13: timestamp = (Long)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public void setMarket(CharSequence value) {
    this.market = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SseAvro>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setMarket(CharSequence value) {
    ...
    public SseAvro build() {
      try {
        ...
        record.market = fieldSetFlags()[0] ? this.market : (CharSequence) defaultValue(fields()[0]);
        record.mdStreamID = fieldSetFlags()[1] ? this.mdStreamID : (CharSequence) defaultValue(fields()[1]);
        record.securityID = fieldSetFlags()[2] ? this.securityID : (CharSequence) defaultValue(fields()[2]);
        record.symbol = fieldSetFlags()[3] ? this.symbol : (CharSequence) defaultValue(fields()[3]);
        record.tradeVolume = fieldSetFlags()[4] ? this.tradeVolume : (Long) defaultValue(fields()[4]);
        record.totalValueTraded = fieldSetFlags()[5] ? this.totalValueTraded : (Long) defaultValue(fields()[5]);
        record.preClosePx = fieldSetFlags()[6] ? this.preClosePx : (Double) defaultValue(fields()[6]);
        record.openPrice = fieldSetFlags()[7] ? this.openPrice : (Double) defaultValue(fields()[7]);
        record.highPrice = fieldSetFlags()[8] ? this.highPrice : (Double) defaultValue(fields()[8]);
        record.lowPrice = fieldSetFlags()[9] ? this.lowPrice : (Double) defaultValue(fields()[9]);
        record.tradePrice = fieldSetFlags()[10] ? this.tradePrice : (Double) defaultValue(fields()[10]);
        record.closePx = fieldSetFlags()[11] ? this.closePx : (Double) defaultValue(fields()[11]);
        record.tradingPhaseCode = fieldSetFlags()[12] ? this.tradingPhaseCode : (CharSequence) defaultValue(fields()[12]);
        record.timestamp = fieldSetFlags()[13] ? this.timestamp : (Long) defaultValue(fields()[13]);
        return record;
      } catch (Exception e) {
